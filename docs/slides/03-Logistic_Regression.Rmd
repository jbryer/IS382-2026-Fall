...
# new_gif
gganimate::anim_save('assets/Logistic_Regression_optim_animation.gif', animation = new_gif)
```

```{r, echo=FALSE}
knitr::include_graphics('assets/Logistic_Regression_optim_animation.gif')
```
...
# new_gif
gganimate::anim_save('assets/Logistic_Regression_optim_animation_logit.gif', animation = new_gif)
```

```{r, echo=FALSE}
knitr::include_graphics('assets/Logistic_Regression_optim_animation_logit.gif')
```
